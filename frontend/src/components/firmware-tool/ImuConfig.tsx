...
export function ImuConfig({
  ...
  const currentImu = useMemo(
    () => sortedImus?.find(({ type: t }) => t === type),
    [type, sortedImus],
  );
    ...
    <Card variant="outlined" sx={{ height: "100%" }}>
      <CardContent>
        ...
        <Grid container spacing={3}>
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <>
                    ...
                    />
                    <HelperComponent
                      text="IMU Rotation configuration"
                      link="https://docs.slimevr.dev/firmware/configuring-project.html#adjust-imu-board-rotation"
                    />
                  </>
                )}
              />
          ...
          {currentImu && currentImu?.hasIntPin && (
            <Grid item xs={12} sm={12}>
              <FormControl fullWidth>
                <Controller
