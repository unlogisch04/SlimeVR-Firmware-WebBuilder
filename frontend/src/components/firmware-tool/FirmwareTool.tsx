    ...
    return (
        <Container component="main" maxWidth="md" sx={{ my: 3 }}>
            ...
            <Alert variant="outlined" severity="info" sx={{ my: 2 }}>
                ...
                <p><Link target="_blank" rel="noopener" href="https://github.com/Lupinixx/SlimeVR-Tracker-ESP/tree/mpu6050-fifo">Lupinixx/mpu6050-fifo</Link> - Attempts to use a FIFO + VQF filter for the imu</p>
                <p><Link target="_blank" rel="noopener" href="https://github.com/0forks/SlimeVR-Tracker-ESP-BMI160/tree/v3dev">0forks/v3dev</Link> - Based off SlimeVR/main, includes various fixes</p>
                <p><Link target="_blank" rel="noopener" href="https://github.com/0forks/SlimeVR-Tracker-ESP-BMI160/tree/v3dev-bmm">0forks/v3dev-bmm</Link> - Improves support for the BMI160 and adds support for the BMM150</p>
